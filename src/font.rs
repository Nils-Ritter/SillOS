...
static FONT_DATA: &[u8] =
    include_bytes!("assets/fonts/spleen-2.2.0/spleen-16x32.psfu");
...
impl Font {
    pub fn new(data: &'static [u8]) -> Self {
        ...
        assert_eq!(
            width,
            FONT_WIDTH,
            "Expected a 16 pixel wide font"
        );

        assert_eq!(
            height,
            FONT_HEIGHT,
            "Expected a 32 pixel high font"
        );
